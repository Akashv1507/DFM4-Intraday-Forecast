    ...
    def fetchRevisedForecastedDemand(self, startTime: dt.datetime, endTime: dt.datetime, revisionNo:str) -> List[Tuple]:
        ...
        try:
            ...
            try:
                ...
                fetch_sql = "SELECT time_stamp, entity_tag, forecasted_demand_value FROM dfm4_dayahead_demand_forecast WHERE time_stamp BETWEEN TO_DATE(:start_time,'YYYY-MM-DD HH24:MI:SS') and TO_DATE(:end_time,'YYYY-MM-DD HH24:MI:SS') ORDER BY time_stamp"
