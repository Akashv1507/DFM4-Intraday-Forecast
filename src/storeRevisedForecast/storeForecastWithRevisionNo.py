        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    del_sql = "DELETE FROM dfm4_forecast_revision_store WHERE time_stamp = :1 and entity_tag=:2 and revision_no =:3"
                    cur.executemany(del_sql, existingRows)
                    insert_sql = "INSERT INTO dfm4_forecast_revision_store(time_stamp,ENTITY_TAG,revision_no,forecasted_demand_value) VALUES(:1, :2, :3, :4)"
